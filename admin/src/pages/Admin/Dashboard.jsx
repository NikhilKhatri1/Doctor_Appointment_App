...
const Dashboard = () => {
  // destruturing Dash data from context
  ...
  return dashData && (
    <div className='m-5'>
      ...
      <div className='flex flex-wrap gap-3'>
        ...
        <div className='flex items-center gap-2 p-4 bg-white border-2 border-gray-100 rounded cursor-pointer hover:scale-105 transistion-all min-w-52'>
